$(document).ready(function() {
  ...
  function renderShotData(data) { 
    ...
    if(data.opponent_id != gamesObject[data.game_id].home) {
      ...
      if (data.shot_made === 1){
      $('#shots-home').append($(shot).css({top: y, left: x}).addClass('madeshot'));
      } else {
      $('#shots-home').append($(shot).css({top: y, left: x}).addClass('missedshot'));
      } 
    
    } else {

       if (data.shot_made === 1){
      $('#shots-away').append($(shot).css({top: y, left: x}).addClass('madeshot'));
      } else {
      $('#shots-away').append($(shot).css({top: y, left: x}).addClass('missedshot'));
      }
    }
